module.exports = {
  loadRegistrationTemplate: (emailId, pwd) => {
    return `
  ...
  loadExpirationTemplate: (html_content) => {
    return `<!DOCTYPE html>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding: 0 2.5em; text-align: left;">
                                <div class="text">
                                    <!-- <h2>Your Items going to Expired.</h2> -->
                                    <h3>Your Items going to Expired.</h3>
                                </div>
                            </td>
                        </tr>
                    </table>
  ...
  loadQRCodeTemplate: (tenantName, url, img) => {
    return `<!DOCTYPE html>
    <html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        <meta charset="utf-8"> <!-- utf-8 works for most cases -->
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                          <td class="logo" style="text-align: center;">
                            <h1><a href="#" style="color: #17bebb !important;font-size: 24px !important;font-weight: 700 !important;font-family: 'Poppins', sans-serif !important;">${tenantName}</a></h1>
                          </td>
                      </tr>
                  </table>
              </td>
                          ...
                          <td style="text-align: center;">
                              <div>
                                  ...
                                  <!-- <span class="position">CEO, Founder at e-Verify</span> -->
                                   <p><a href="${url}" class="btn btn-primary" style="border:1px solid #17bebb !important; padding:15px">Go to your Business</a></p>
                               </div>
                          </td>
                        </tr>
                </table>
